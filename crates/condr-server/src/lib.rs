...
pub use server::{BoundServer, ClientConnection, ServerConfig, ServerHandle, stop_server};
...
/// Ensures the local detached server exists and accepts the current protocol.
pub fn ensure_local_server() -> std::io::Result<Endpoint> {
