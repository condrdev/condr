...
7. Use the platform local-data directory, `<data>/condr/worktrees/<repo>/<branch-slug>`, as the fixed managed checkout root. Add a TOML override only when a real storage-location need appears.
