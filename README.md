...
- **Agent driven** — Agents can use Condr too: create Panes, read output, assign tasks, and talk to other agents through the CLI.
- **Real terminals** — Condr uses the `alacritty` core. Every agent gets a real terminal. Run any CLI agent or terminal program.
